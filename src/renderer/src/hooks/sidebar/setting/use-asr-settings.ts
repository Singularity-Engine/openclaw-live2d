...
export const useASRSettings = () => {
  ...
  }, [updateSettings, localVoiceInterruption, localAutoStartMic, localAutoStartMicOnConvEnd]);
  ...
  const handleCancel = useCallback((): void => {
    ...
    forceUpdate();
  }, [setAutoStopMic, setAutoStartMicOn, setAutoStartMicOnConvEnd, forceUpdate]);
